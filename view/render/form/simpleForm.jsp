<head>
	...
	<script>
		...
		var createTdObj = {
			tableInfo : {
				td : [
					...
					{row : 0, sort_pos : 7, name : 'attributes', label: 'html커스텀속성[{key:,value:},..]',showLabel : true, type: 'text',style : 'min-width:500px;',class: 'js-eval'},
					{row : 0, sort_pos : 8, name : 'type', label: 'input타입',showLabel : true, type: 'select',
						options : {isAjax : false, array : [{key : 'select' , value : '설렉트박스'},{key : 'text' , value : '텍스트'},{key : 'number' , value : '숫자'},{key : 'textArea' , value : '텍스트에어리어'}]}},
					{row : 0, sort_pos : 9, name : 'optionIsAjax', label: '설렉트박스ajax호출여부',showLabel : true, type: 'select',
						options : {isAjax : false, array : [{key : 'true' , value : '네'},{key : 'false' , value : '아니요'}]}},
					{row : 0, sort_pos : 10, name : 'array', label: '셀렉트url또는optionHtml[selectbox 인 경우에만 해당]',showLabel : true, type: 'text',style : 'min-width:600px;',class: 'js-eval'},
					{row : 0, sort_pos : 11, name : 'class', label: '커스텀클래스 지정',showLabel : true, type: 'text',style : 'min-width:500px;'},
					{row : 0, sort_pos : 12, name : 'style', label: '커스텀style 지정',showLabel : true, type: 'text',style : 'min-width:500px;'},
				],
				th : [
					{mainLabel : 'tableInfo>td' , explainHtml : '1.tableInfo에 td 오브젝트 json만들기'},
				]
			},
			pageInfo : [{
				pageTitle : '',
		...
		var createThObj = {
			tableInfo : {
				td : [
					{row : 0, sort_pos : 1, name : 'mainLabel', label: '메인레이블',showLabel : true, type: 'text',style:'min-width:600px;'},
					{row : 0, sort_pos : 2, name : 'explainHtml', label: '레이블상세설명[있는경우,div로append됨]',showLabel : true, type: 'text',style:'min-width:600px;'},
				],
				th : [
		...
		var createPageInfoObj = {
			tableInfo : {
				td : [
					{row : 0, sort_pos : 1, name : 'pageTitle', label: '페이지제목',showLabel : true, type: 'text',style:'min-width:400px;'},
					{row : 0, sort_pos : 2, name : 'formTitle', label: 'form제목',showLabel : true, type: 'text',style:'min-width:400px;'},
					{row : 0, sort_pos : 3, name : 'xmlId', label: '고유id[saveAction override 안하는경우,bld에 mapping되는 xmlId]',showLabel : true, type: 'text',style:'min-width:400px;'},
					{row : 0, sort_pos : 4, name : 'saveButtonText', label: '버튼텍스트',showLabel : true, type: 'text',style:'min-width:400px;'},
		...
		$(document).ready(function(){
			...
			/*
			var $f = $('#write-template-rendered-form') ,f = $f[0];
			
			$('.js-date-picker',$f).datepicker({autoclose:true, language:"kr",
			   onSelect: function() {
				   jQuery(this).change();
			   }
...
<body>
	<div class="body-container col-md-10">
		<input type="button" class="btn-primary pull-right" id="btnRender" value = "전체생성"/>
		<textArea id="renderedArea" rows="10" cols="130"></textArea>
		<textArea id="renderedHtmlArea" rows="10" cols="130"></textArea>
    </div>
	
	<div class="body-container col-md-10" id="sampleContainer-rendered">
		<form id ="write-template-rendered-form"></form>
	</div>
	
	<div class="body-container col-md-10" id="sampleContainer-td">
		<form id ="write-template-tableInfo-td-form"></form>
	</div>
	
	<div class="body-container col-md-10">
		<textArea id="tdArea" rows="10" cols="150" class="js-help-render"></textArea>
	</div>
	
	<div class="body-container col-md-10" id="sampleContainer-th">
		<form id ="write-template-tableInfo-th-form"></form>
	</div>
	
	<div class="body-container col-md-10">
		<textArea id="thArea" rows="10" cols="150" class="js-help-render"></textArea>
	</div>
	
	<div class="body-container col-md-10" id="sampleContainer-pageInfo">
		<form id ="write-template-pageInfo-form"></form>
	</div>
	
	<div class="body-container col-md-10">
		<textArea id="pageInfoArea" rows="10" cols="150" class="js-help-render"></textArea>
	</div>
</body>
